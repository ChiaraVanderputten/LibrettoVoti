...
public class TestLibretto {
	...
	LibrettoMigliorato librettoMigliorato = new LibrettoMigliorato();
	
	Voto voto1 = new Voto("Analisi 1", 30, LocalDate.of(2019, 2, 15));
	
	libretto.add(voto1); //add per aggiungere al libretto i voti
	librettoMigliorato.add(voto1);
	...
	librettoMigliorato.add(new Voto("Fisca 1", 28, LocalDate.of(2019, 6, 17)));
	librettoMigliorato.add(new Voto("Informatica", 20, LocalDate.of(2019, 9, 12)));
	librettoMigliorato.add(new Voto("Chimica", 25, LocalDate.of(2019, 6, 20)));
	...
	Voto analisi2 =libretto.ricercaVoto("Analisi 3"); //esame che non esiste
	...
	if(libretto.esisteDuplicato(chimicaDoppio))
		System.out.println("L' "+chimicaDoppio+" è il doppio rispetto un esame nel libretto \n");
	else
		System.out.println("L' "+chimicaDoppio+" non è doppio rispetto un esame nel libretto \n");
	
	if(libretto.esisteConflitto(chimicaConflitto))
		System.out.println("L' "+chimicaConflitto+" è in conflitto con un esame nel libretto \n");
	else
